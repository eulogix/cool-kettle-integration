...
public class FileUploaderStep extends BaseStep implements StepInterface {
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		System.out.println(" carlo " + meta.fields.get("coolEnvironment"));
		
		ArrayList<KettleAppConfiguration> confs = coolEnvironment.getConfiguredCoolApps();
		for(int i=0; i<confs.size(); i++) {
			System.out.println(" gianni " + confs.get(i).getName());
		...
		if(app != null) {
			...
			Object[] outputRow;
			try {
				outputRow = RowDataUtil.addValueData(r, data.outputRowMeta.size() - 1, 
						app.uploadFile(
		...
		} else System.out.println(" gianpiero " + meta.fields.get("coolEnvironment"));
