 ...
 * 
 */
public class NotificationSendStepDialog extends CoolStepDialog implements StepDialogInterface {
	 ...
	 */
	public NotificationSendStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		meta = (NotificationSendStepMeta) in;
		PKG = NotificationSendStepMeta.class;
		messagesPrefix = "NotificationSendStep";		
	}
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG, "NotificationSendStep.Shell.Title")); 
