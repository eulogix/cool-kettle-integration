...
public class FileGetPropertiesStep extends CoolStep implements StepInterface {
	 ...
	 */
	public FileGetPropertiesStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis) {
	...
	public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
		...
		FileGetPropertiesStepMeta meta = (FileGetPropertiesStepMeta) smi;
		FileGetPropertiesStepData data = (FileGetPropertiesStepData) sdi;
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		if(app != null) {
			...
			String schemaName = getFieldValue(r, meta.fields.get("schemaName").toString()).toString();
			String actualSchema = getFieldValue(r, meta.fields.get("actualSchema").toString()).toString();
