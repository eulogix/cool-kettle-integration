...
@Step(	
		id = "CoolFileGetPropertiesStep",
		image = "file-get-properties.png",
		i18nPackageName="com.eulogix.cool.pentaho.steps.file_get_properties",
		name="FileGetPropertiesStep.Name",
		description = "FileGetPropertiesStep.TooltipDesc",
		categoryDescription="FileGetPropertiesStep.Category"
)
public class FileGetPropertiesStepMeta extends CoolStepMeta implements StepMetaInterface {
	 ...
	 */
	private static Class<?> PKG = FileGetPropertiesStepMeta.class; // for i18n purposes
	
	/**
	 * Constructor should call super() to make sure the base class has a chance to initialize properly.
	 */
	public FileGetPropertiesStepMeta() {
		super();
	}
	...
	public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
		return new FileGetPropertiesStepDialog(shell, meta, transMeta, name);
	}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
		return new FileGetPropertiesStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
	}
	...
	public StepDataInterface getStepData() {
		return new FileGetPropertiesStepData();
	}	
	 ...
	 */
	public Object clone() {
		FileGetPropertiesStepMeta retval = (FileGetPropertiesStepMeta) super.clone();
		retval.setUpFields();
		return retval;
	}
