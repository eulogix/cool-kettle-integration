...
@Step(	
		id = "CoolBinaryFileOutputStep",
		image = "binary-file-output.png",
		i18nPackageName="com.eulogix.cool.pentaho.steps.binary_file_output",
		name="BinaryFileOutputStep.Name",
		description = "BinaryFileOutputStep.TooltipDesc",
		categoryDescription="BinaryFileOutputStep.Category"
)
public class BinaryFileOutputStepMeta extends CoolStepMeta implements StepMetaInterface {
	 ...
	 */
	private static Class<?> PKG = BinaryFileOutputStepMeta.class; // for i18n purposes
	
	/**
	 * Constructor should call super() to make sure the base class has a chance to initialize properly.
	 */
	public BinaryFileOutputStepMeta() {
		super();
	}
	...
	public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
		return new BinaryFileOutputStepDialog(shell, meta, transMeta, name);
	}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
		return new BinaryFileOutputStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
	}
	...
	public StepDataInterface getStepData() {
		return new BinaryFileOutputStepData();
	}	
	 ...
	 */
	public Object clone() {
		BinaryFileOutputStepMeta retval = (BinaryFileOutputStepMeta) super.clone();
		retval.setUpFields();
		return retval;
	}
	...
	public void getFields(RowMetaInterface inputRowMeta, String name, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space, Repository repository, IMetaStore metaStore) throws KettleStepException{
		...
		ValueMetaInterface pName = new ValueMeta("created", ValueMeta.TYPE_BOOLEAN);
