...
@Step(	
		id = "CoolTemplateRenderStep",
		image = "template-render.png",
		i18nPackageName="com.eulogix.cool.pentaho.steps.template_render",
		name="TemplateRenderStep.Name",
		description = "TemplateRenderStep.TooltipDesc",
		categoryDescription="TemplateRenderStep.Category"
)
public class TemplateRenderStepMeta extends CoolStepMeta implements StepMetaInterface {
	 ...
	 */
	private static Class<?> PKG = TemplateRenderStepMeta.class; // for i18n purposes
	
	/**
	 * Constructor should call super() to make sure the base class has a chance to initialize properly.
	 */
	public TemplateRenderStepMeta() {
		super();
	}
	...
	public void setUpFields() {
		...
		fields.put("repositoryId", "");
		fields.put("repositoryParameters", "");
		fields.put("templatePath", "");
		fields.put("templateData", "");
		fields.put("outputFormat", "");
		fields.put("rendererParameters", "");
	}
	...
	public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
		return new TemplateRenderStepDialog(shell, meta, transMeta, name);
	}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
		return new TemplateRenderStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
	}
	...
	public StepDataInterface getStepData() {
		return new TemplateRenderStepData();
	}	
	 ...
	 */
	public Object clone() {
		TemplateRenderStepMeta retval = (TemplateRenderStepMeta) super.clone();
		retval.setUpFields();
		return retval;
	}
	...
	public void getFields(RowMetaInterface inputRowMeta, String name, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space, Repository repository, IMetaStore metaStore) throws KettleStepException{
		...
		metas.add( new ValueMeta("renderer_message", ValueMeta.TYPE_STRING) );
		metas.add( new ValueMeta("rendered_file_size", ValueMeta.TYPE_INTEGER) );
		metas.add( new ValueMeta("rendered_file_content", ValueMeta.TYPE_BINARY) );
