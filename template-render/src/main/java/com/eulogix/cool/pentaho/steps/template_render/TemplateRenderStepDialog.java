 ...
 * 
 */
public class TemplateRenderStepDialog extends CoolStepDialog implements StepDialogInterface {

	// this is the object the stores the step's settings
	// the dialog reads the settings from it when opening
	// the dialog writes the settings to it when confirmed 
	private TemplateRenderStepMeta meta;
	 ...
	 */
	public TemplateRenderStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		meta = (TemplateRenderStepMeta) in;
		PKG = TemplateRenderStepMeta.class;
		messagesPrefix = "TemplateRenderStep";		
	}
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG, "TemplateRenderStep.Shell.Title")); 
