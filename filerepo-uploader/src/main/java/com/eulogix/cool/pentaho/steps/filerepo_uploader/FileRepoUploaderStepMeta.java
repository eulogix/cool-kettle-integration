package com.eulogix.cool.pentaho.steps.filerepo_uploader;
...
@Step(	
		id = "CoolFileRepoUploaderStep",
		image = "filerepo-uploader.png",
		i18nPackageName="com.eulogix.cool.pentaho.steps.filerepo_uploader",
		name="FileRepoUploaderStep.Name",
		description = "FileRepoUploaderStep.TooltipDesc",
		categoryDescription="FileRepoUploaderStep.Category"
)
public class FileRepoUploaderStepMeta extends CoolStepMeta implements StepMetaInterface {
	 ...
	 */
	private static Class<?> PKG = FileRepoUploaderStepMeta.class; // for i18n purposes
	
	/**
	 * Constructor should call super() to make sure the base class has a chance to initialize properly.
	 */
	public FileRepoUploaderStepMeta() {
		super();
	}
	...
	public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
		return new FileRepoUploaderStepDialog(shell, meta, transMeta, name);
	}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
		return new FileRepoUploaderStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
	}
	...
	public StepDataInterface getStepData() {
		return new FileRepoUploaderStepData();
	}	
	 ...
	 */
	public Object clone() {
		FileRepoUploaderStepMeta retval = (FileRepoUploaderStepMeta) super.clone();
		retval.setUpFields();
		return retval;
	}
