 ...
 * 
 */
public class FileRepoUploaderStepDialog extends CoolStepDialog implements StepDialogInterface {

	// this is the object the stores the step's settings
	// the dialog reads the settings from it when opening
	// the dialog writes the settings to it when confirmed 
	private FileRepoUploaderStepMeta meta;
	 ...
	 */
	public FileRepoUploaderStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		meta = (FileRepoUploaderStepMeta) in;
		PKG = FileRepoUploaderStepMeta.class;
		messagesPrefix = "FileRepoUploaderStep";		
	}
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG, "FileRepoUploaderStep.Shell.Title")); 
