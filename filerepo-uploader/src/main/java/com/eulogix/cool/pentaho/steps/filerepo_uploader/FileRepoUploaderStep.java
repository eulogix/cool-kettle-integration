...
public class FileRepoUploaderStep extends BaseStep implements StepInterface {
	 ...
	 */
	public FileRepoUploaderStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis) {
	...
	public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
		...
		FileRepoUploaderStepMeta meta = (FileRepoUploaderStepMeta) smi;
		FileRepoUploaderStepData data = (FileRepoUploaderStepData) sdi;
	...
	public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
		...
		if(app != null) {
			...
			Object[] outputRow;
			try {
				JsonObject uploadedFile = app.getFileRepositoryApi().uploadFile(
						...
						getFieldValue(r, meta.fields.get("filePath").toString()).toString(),
